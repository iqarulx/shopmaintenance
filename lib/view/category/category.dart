                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Text(
                          categoryList[index].name!.length > 20
                              ? '${categoryList[index].name!.substring(0, 20)}...'
                        ...
                        Text(
                          "Created by: ${categoryList[index].creator!.length > 20 ? '${categoryList[index].creator!.substring(0, 20)}...' : categoryList[index].creator!}",
                          style: const TextStyle(
                            color: Colors.grey,
                            fontSize: 12,
                          ),
